    ...
    <fieldset className="flex h-8 p-0 m-0 rounded-[999999px] border border-shadow">
      ...
      <div className="mt-[-1px] ml-[-1px]">
        ...
        <label
          ...
          className={`flex items-center justify-center h-8 w-8 cursor-pointer rounded-[999999px] group${theme === "system" ? " border-r border-shadow" : ""}`}
        >
          ...
          <svg height="16" strokeLinejoin="round" viewBox="0 0 16 16" width="16">
            <path
              fillRule="evenodd"
              clipRule="evenodd"
              className={`group-hover:fill-neutral-1000 duration-150 ${theme === "system" ? "dark:fill-neutral-300 fill-neutral-800" : "fill-neutral-700"}`}
      ...
      <div className="mt-[-1px]">
        ...
        <label
          ...
          className={`flex items-center justify-center h-8 w-8 cursor-pointer rounded-[999999px] group${theme === "light" ? " border border-shadow" : ""}`}
        >
          ...
          <svg height="16" strokeLinejoin="round" viewBox="0 0 16 16" width="16">
            <path
              ...
              className={`group-hover:fill-neutral-1000 duration-150 ${theme === "light" ? "fill-neutral-1000" : "fill-neutral-700"}`}
            />
          </svg>
        </label></div>
      <div className="mt-[-1px] mr-[-1px]">
        ...
        <label
          ...
          className={`flex items-center justify-center h-8 w-8 cursor-pointer rounded-[999999px] group${theme === "dark" ? " fill-white border-l border-shadow" : ""}`}
        >
          ...
          <svg height="16" strokeLinejoin="round" viewBox="0 0 16 16" width="16">
            <path
              ...
              className={`group-hover:fill-neutral-1000 duration-150 ${theme === "dark" ? "fill-neutral-1000" : "fill-neutral-700"}`}
            />
          </svg>
        </label>
      </div>
